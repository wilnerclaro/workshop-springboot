package com.cursojavanelio.course.config;
...
import com.cursojavanelio.course.entities.Payment;
import com.cursojavanelio.course.entities.Product;
import com.cursojavanelio.course.entities.User;
import com.cursojavanelio.course.entities.enums.OrderStatus;
import com.cursojavanelio.course.repositories.CategoryRepository;
import com.cursojavanelio.course.repositories.OrderItemRepository;
...
import com.cursojavanelio.course.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), u2 ,OrderStatus.WAITINNG_PAYMENT);
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u1 ,OrderStatus.WAITINNG_PAYMENT);
